...
\newglossaryentry{noninversegammadistribution}{
  name={NIG},
  description={\textit{Non-Inverse-Gamma-Verteilung} bezeichnet eine Wahrscheinlichkeitsverteilung, die im Gegensatz zur Inversen-Gamma-Verteilung zur Modellierung von Unsicherheiten verwendet wird, ohne auf eine explizite Inversion der Gamma-Verteilung zurückzugreifen. Sie kommt in evidenzbasierten Regressionsmodellen zum Einsatz, bei denen alternative Verteilungen zur Beschreibung epistemischer oder aleatorischer Unsicherheiten genutzt werden, um numerische Stabilität oder interpretatorische Vorteile zu erzielen}
}
