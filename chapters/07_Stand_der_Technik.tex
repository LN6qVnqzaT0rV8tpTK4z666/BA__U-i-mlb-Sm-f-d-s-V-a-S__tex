...
% Als weiterer Methodenbaustein soll \textit{epistemic learning} nach Manchingal eingeführt werden. R4.1 stellt dies gegenüber dem konventionellem Lernprozess. Ein Datensatz (Abb. \glqq Training set \grqq) $\mathcal{D} = \{ (\mathbf{x}_i, y_i) \}_{i=1}^N$ trägt nach Manchingal implizit die Kosten 
