...
Ein in der Literatur üblicher Ansatz ist das Trainineren von \gls{Evidenzbasierte neuronale Netze} auf Evidentiellem Wissen zur Optimierung des Wissens in der Anwendungsdomäne. Manchingals Grafiken liefern die Übersicht für in VaMai in betracht gezogenen \gls{uncertaintyquantification}-Techniken in R.4.1, R.4.2 . Dabei können insbesondere die Wahrscheinlichkeitsräume mittels Jøsang (2016): Subjective Logic \gls{josang2016subjective} umfassend eingeordnet werden und liefern in der Modellierung auch die Grundlage um Ulmer einzuordnen. 

\begin{quote}
  Difference to traditional bayesian theory; aleatoric, epistemic is explicit in subjective logic
\end{quote}

Jøsang liefert den Zusammenhang für \gls{Bayesianische neuronale Netze} ~\parencite[vgl. S.42]{josang2016subjective}. Er soll hier auch für \gls{EvidentialDeepLearning} gewählt werden. Jøsang erweitert \gls{Aleatorische Unsicherheit}, \gls{Epistemische Unsicherheit} als Unsicherheiten erster Ordnung zu Unsicherheiten zweiter Ordnung \glqq Aleatorischic Opinion \grqq (\gls{aleatoricopinion}), \glqq Epistemic Opinion \grqq (\gls{epistemicopinion}) (vgl. Jøsang ~\parencite[S.22, Z.10-16; S.22 Z. 17-26; S.23, Z. 5-; S.23 Z.9-12]{josang2016subjective}). \par\noindent\\

Subjektive Logik gibt eine klare Hierarchie für \gls{Evidenzbasierte neuronale Netze} zur Eingrenzung von \glqq Zero Evidence Regions \grqq unabhängig von gewählten und der Literatur stark individualisierten und variierenden Loss-Functions. Jøsang füllt damit, \glqq [the] missing uniform definition of what is not known\grqq ~\parencite[vgl. S.42]{josang2016subjective} für \gls{Bayesianische neuronale Netze}, \gls{Evidenzbasierte neuronale Netze}. 
