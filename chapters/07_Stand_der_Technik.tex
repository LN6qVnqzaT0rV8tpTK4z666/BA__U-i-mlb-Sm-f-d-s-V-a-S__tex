  ...
  \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}l|X|X|}
    ...
    \parbox[t]{\linewidth}{
      \begin{itemize}[topsep=0em, itemsep=0.4em, leftmargin=*, label={}]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite[S.~28–30]{bishop2006pattern}\end{scriptsize}
    ...
    \parbox[t]{\linewidth}{
      \begin{itemize}[topsep=0em, itemsep=0.4em, leftmargin=*, label={}]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite[S.~30–32]{bishop2006pattern}\end{scriptsize}
      \end{itemize}
    }
    &
    \parbox[t]{\linewidth}{
...
%     \begin{itemize}[topsep=0em, itemsep=0em, leftmargin=*, label={}]
%       \item Posterior-Verteilung \\
%       \( p(\theta \mid \mathcal{D}) \) \\
%       \parencite[Kap.~3]{blundell2015weight}
...
%       \item Konfidenzintervall \\
%       \( \hat{y} \pm z \cdot \sigma \) \\
%       \parencite[S.~4–5]{vovk2005algorithmic}
%       \item Unsicherheitsquantifizierung durch Konfidenzintervalle \\
%       \parencite{angelopoulos2021gentle}
...
%     \begin{itemize}[topsep=0em, itemsep=0em, leftmargin=*, label={}]
%       \item Bayesianische Unsicherheit \\ 
%       \( p(\theta \mid \mathcal{D}) \) \\ 
%       \parencite[S.~40–42]{gal2016uncertainty}
...
%       \parencite[S.~63–65]{shafer2008tutorial}
%       \item GPR: UQ-Ansatz mit Kernel-Methoden und Training \\ 
%       \parencite{rasmussen2006gaussian}
%     \end{itemize}
%     \\
%     \hline
...
\begin{table}[!htpb]
  ...
  \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}l|X|X|X|}
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*[Kap.~3]{blundell2015weight}\end{scriptsize}
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*[S.~4–5]{vovk2005algorithmic}\end{scriptsize}
        \item \gls{uncertaintyquantification} ü. Konfidenzintervalle \par
        \begin{scriptsize}\textit{Quelle:} \parencite*{angelopoulos2021gentle}\end{scriptsize}
        \item Ensemble \par
        \begin{scriptsize}\textit{Quelle:} \parencite*{angelopoulos2021gentle}\end{scriptsize}
    \end{itemize}
    \vspace{0.3em}
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*[S.~448–450]{mackay1992practical}\end{scriptsize}
        \item Einfluss von Prioren \par
        \begin{scriptsize}\textit{Quelle:} \parencite*[Kap.~5]{rasmussen2006gaussian}\end{scriptsize}
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*[S.~63–65]{shafer2008tutorial}\end{scriptsize}
        \item Einfluss von \gls{confidenceregion} \par
        \begin{scriptsize}\textit{Quelle:} \parencite*{vovk2005algorithmic}\end{scriptsize}
    \end{itemize}
    \vspace{0.3em}
    \end{minipage} &
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*[S.~41–42]{gal2016uncertainty}\end{scriptsize}
    ...
    \begin{itemize}[leftmargin=*, label={}, itemsep=0.125em, topsep=0em, parsep=0em]
        ...
        \begin{scriptsize}\textit{Quelle:} \parencite*{shafer2008tutorial}\end{scriptsize}
    \end{itemize}
    \vspace{0.3em}
    \end{minipage} &
