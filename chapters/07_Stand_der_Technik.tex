...
\begin{quote}
  Difference to [\dots] bayesian theory [is] \gls{Aleatorische Unsicherheit}, \gls{Epistemische Unsicherheit} is \textit{explicit} in subjective logic [...]. 
\end{quote}
...
% Als Methodenbaustein soll \textit{epistemic learning} nach Manchingal eingeführt werden. R4.1 
