...
% \begin{figure}[htpb]
%   \centering
%   % Beispiel: Abbildung könnte hier eingebunden werden
%   \includegraphics[width=0.7\textwidth]{figures/munitionsreste.png}
%   \caption[Lokalisierung von Munitionsresten]{Lokalisierung von Munitionsresten (Quelle: DAM 2024)}\label{fig:munition}
% \end{figure}

% --- Continue with your original section content below ---
