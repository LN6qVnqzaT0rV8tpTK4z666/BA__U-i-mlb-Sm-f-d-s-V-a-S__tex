...
Ein \textbf{Deep Neural Network (\gls{DeepNeuralNetwork})} erweitert ein \gls{neuronalesnetzwerk} um mehrere versteckte Schichten, Hidden Layer. Dies erhöht die Tiefe des Netzwerks:
