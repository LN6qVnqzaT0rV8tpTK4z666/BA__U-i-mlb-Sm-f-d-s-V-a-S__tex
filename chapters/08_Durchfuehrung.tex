...
\begin{figure}[!ht]
  ...
  \caption{Vergleich von GroundTruth, aleatorischer und epistemischer Unsicherheit unter Konfiguration 1}
  \label{fig:three_subfigures1}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Vergleich von GroundTruth, aleatorischer und epistemischer Unsicherheit unter Konfiguration 2}
  \label{fig:three_subfigures2}
\end{figure}



% \paragraph{Einzelnes 3D-Signal \gls{EvidentialDeepLearning} Overfit} 


% Als nächtes wird vorhandene Noise-Klasse eingebunden, Determinismus für Zufallsgeneration überschrieben, um auf allen Signalklassen größere aleatorische Varianz durch Störfunktion zu erhalten. 
