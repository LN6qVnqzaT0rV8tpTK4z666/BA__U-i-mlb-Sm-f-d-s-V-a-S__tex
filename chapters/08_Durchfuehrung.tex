...
\paragraph{Einzelnes 3D-Signal \gls{EvidentialDeepLearning}, Gauss-Funktion, Unterapproximation zu Approximation für $n=10$, $n_{\Delta}$, $n_{\frac{\Delta}{2}}$}
...
\begin{figure}[!ht]
  ...
  \caption{Vergleich der Plots Ground-Truth zu Vorhersage für $n_{min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
  \label{fig:matrix_plot}
\end{figure}
