...
Für weitere Schritte wird das wie folgt interpretiert. Im Projekt VaMai möchte man die alaotrische und epistemische Varianz pro Signal präzsiser erfassen, sodass eben geschilderte Beobachtungen nicht hinreichend sind. 
...
% \paragraph{Multi 3D-Signal \gls{EvidentialDeepLearning} Underfit zu annäherndem Fit und Störfunktion} 




% \paragraph{Multi 3D-Signal \gls{EvidentialDeepLearning} Overfit mit Störfunktion} 
