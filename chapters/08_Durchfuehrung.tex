...
\paragraph{Ausgangs-Sampling} Das ursprüngliche Latin-Hypercube-Sampling soll in der Samplezahl varriert werden mit $n = { n_{min}:=10, n_{frac{\Delta}{2}}, n_{\Delta} }$. $n_{\Delta}$ als Maximum soll abhängig von der Konvergenz der Loss-Funktion sein, die sich an diesem Punkt nicht mehr signifikant ändert. Dieser wird durch Try-and-Error-Versuche bestimmt aus vorgegebenen Samplegrößen zum Vereinfachen des Experiments, $n = \{ 10, 50, 100, 150, 200 \}$. $n_{\frac{\Delta}{2}}$ entspricht dem intervallhalbierenden Wert von $\left[ n_{\min},\; n_{\Delta} \right]$. Im Experiment werden zuerst $n_{\min}$, dann anhand der Konvergenzrichtung sowie vorgegebenen $n$, $n_{\Delta}$ bestimmt und schließlich $n_{\frac{\Delta}{2}}$.
...
\paragraph{Loss Einzelnes 3D-Signal \gls{EvidentialDeepLearning}, Gauss-Funktion, Unterapproximation zu Approximation für $n=10$, $n_{\Delta}$, $n_{\frac{\Delta}{2}$}
...
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y11.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y12.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y13.png}
%   \end{minipage}
...
%   % Zeile 2: n_Delta/2
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$n_{\Delta}/2$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
...
%   \caption{Vergleich der Vorhersagen und Unsicherheiten für $n_{\mathrm{min}}$, $n_{\Delta}/2$ und $n_{\Delta}$.}
%   \label{fig:matrix_plot}
% \end{figure}



\paragraph{Interpretation Einzelnes 3D-Signal \gls{EvidentialDeepLearning}, Gauss-Funktion, Unterapproximation zu Approximation für $n=10$, $n_{\Delta}$, $n_{\frac{\Delta}{2}$}
...
\paragraph{Interpretation Einzelnes 3D-Signal \gls{EvidentialDeepLearning}, Hyperwürfel-Funktion, Unterapproximation zu Approximation}
