...
% Herr Autenrieths Kritikalitätsraums Unsicherheitsbehaftung wird zunächst äquivalent zu Aminis Modell R.4.4 refaktorisiert indem Aminis Evidential Deep Learning Repository wegen fehlender Projektstruktur direkt integriert wird. Vorhandene Noise-Klasse wird eingebunden, Determinismus für Zufallsgeneration überschrieben. Visuali 
