...
% Beschriftung
\captionof{figure}{Vergleich Ground-Truth $y_{\mathrm{true}}$ zu Vorhersage $\hat{y}$ für drei Trainingsgrößen: $n_{\min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
...
\begin{figure}[!ht]
  ...
  \end{minipage}
  \hfill
  % % Zweites Bild: Aleatorische Unsicherheit (hier Platzhalter)
  % \begin{minipage}[t]{0.32\textwidth}
  %   \centering
  %   \vspace*{0.5cm} % Falls Platzhalterhöhe
  %   \textit{(kein Plot vorhanden)}
  %   % \includegraphics[width=\linewidth]{../figures/y62.png}
