...
\paragraph{Approximations-Parametrisierung \gls{Evidenzbasierte neuronale Netze}} Zur Bewertung von Approximationen des \gls{Evidenzbasierte neuronale Netze} wird folgende Bewertung herangezogen. % Grundsätzlich liefert Herr Autenrieths Kritikalitätssoftware ein Modul zum attributweisen Raumvergleich in dem man dies zukünftig berücksichtigen könnte. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Aufgreifen in Diskussion unter DH als BNN Kritikalitätsabdeckung Ausblick ENN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Reserviere genug Platz; passe ggf. an (z.B. 24 Zeilen)
...
% ---- dein Minipage-Raster, UNVERÄNDERT, aber OHNE \begin{figure} ... \end{figure} ----
...
% Zeile 1
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\min}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n100_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n100_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n100_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 2
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\frac{\Delta}{2}}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n150_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n150_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n150_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 3
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\Delta}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n200_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n200_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y1_n200_3.png}\end{minipage}

% Eine EINZIGE Caption für alles:
\captionof{figure}{Vergleich der evidentiellen Ausgaben für $n_{\min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
\label{fig:matrix_plot_gauss}

% ---- wenn du weitere Reihen/Gruppen mit eigener Caption willst, wiederhole das Raster und setze eine zweite \captionof{figure}{...} ----
% Spaltenüberschriften
\begin{minipage}{0.05\textwidth}\vspace{0.5cm}\end{minipage}%
...
% Zeile: Pfad 100, 150, 200
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{Ausgabe}\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n100__run2.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n150__run3.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n200__run3.pdf}
\end{minipage}
...
% Zeile: Plots 100, 150, 200
\begin{minipage}{0.05\textwidth}
    \centering\rotatebox{90}{$\hat{y} \ \text{vs.}\  y_{\mathrm{true}}$}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n100.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n150.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n200.pdf}
\end{minipage}

% Beschriftung
\captionof{figure}{Vergleich Ground-Truth $y_{\mathrm{true}}$ zu Vorhersage $\hat{y}$ mit $n_{\min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
...
% Zeile 1
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\min}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n100_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n100_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n100_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 2
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\frac{\Delta}{2}}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n150_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n150_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n150_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 3
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\Delta}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n200_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n200_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y2_n200_3.png}\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n100__run1.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n150__run4.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-09__n200__run2.pdf}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n100.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n150.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output2__hypercube__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-09__n200.pdf}
\end{minipage}
...
% \textbf{Einzelnes 3D-Signal \gls{EvidentialDeepLearning}, Gauss-Funktion, Unterapproximation zu Approximation für $n=10$, $n_{\Delta}$, $n_{\frac{\Delta}{2}}$}
...
%   % Spaltenüberschriften
%   \begin{minipage}{0.05\textwidth}
%     \vspace{0.5cm} % Platz, damit Spaltenüberschrift mittig ist
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{$\gamma = \mu$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{Aleatorische Unsicherheit}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{Epistemische Unsicherheit}
%   \end{minipage}
...
%   % Zeile 1: n_min
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$n_{\mathrm{min}}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y21.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y22.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y23.png}
%   \end{minipage}
...
%   % Zeile 2: n_Delta/2
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$n_{\frac{\Delta}{2}}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y21.png}
%   \end{minipage}%
...
%   % Zeile 3: n_Delta
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$n_{\Delta}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y31.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y32.png}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/y33.png}
%   \end{minipage}

%   \caption{Vergleich der evidentiellen Ausgaben für $n_{min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
%   \label{fig:matrix_plot}
...
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{$n_{\mathrm{min}}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{$n_{\frac{\Delta}{2}}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering \textbf{$n_{\Delta}$}
%   \end{minipage}
...
%   % Zeile 1: n_min
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$\text{Loss }\mathcal{L}$}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-08__n100__run1.pdf}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-08__n150__run2.pdf}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/loss_plot__2025-08-08__n200__run4.pdf}
%   \end{minipage}
...
%   % Zeile 1: n_min
%   \begin{minipage}{0.05\textwidth}
%     \centering\rotatebox{90}{$\hat{y} \quad\text{vs.}\quad y_{\mathrm{true}}$}
%   \end{minipage}%     
%   \begin{minipage}{0.3\textwidth} 
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-08__n100.pdf}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-08__n150.pdf}
%   \end{minipage}%
%   \begin{minipage}{0.3\textwidth}
%     \centering\includegraphics[width=\linewidth]{../figures/output___gauss__epoch_2000__neurons_64__layer_2/Candidate/pred_vs_gt__2025-08-08__n200.pdf}
%   \end{minipage}

%   \caption{Vergleich der Plots Ground-Truth $ y_{\mathrm{true}}$ zu Vorhersage $\hat{y}$ für $n_{min}$, $n_{\frac{\Delta}{2}}$ und $n_{\Delta}$.}
%   \label{fig:matrix_plot}
% \end{figure}
...
% Zeile 1
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\min}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n100_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n100_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n100_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 2
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\frac{\Delta}{2}}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n150_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n150_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n150_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 3
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\Delta}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n200_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n200_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y3_n200_3.png}\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n100__run3.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n150__run2.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n200__run1.pdf}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n100.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n150.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__gaussian__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n200.pdf}
\end{minipage}
...
% Zeile 1
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\min}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n10_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n10_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n10_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 2
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\frac{\Delta}{2}}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n50_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n50_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n50_3.png}\end{minipage}

\vspace{0.125cm}

% Zeile 3
\begin{minipage}{0.05\textwidth}\centering\rotatebox{90}{$n_{\Delta}$}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n100_1.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n100_2.png}\end{minipage}%
\begin{minipage}{0.3\textwidth}\centering\includegraphics[width=\linewidth]{../figures/y4_n100_3.png}\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n10__run2.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n50__run0.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/loss_plot__2025-08-10__n100__run4.pdf}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n10.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n50.pdf}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/output3__hypercube__epoch_4000__neurons_128__layer_2/Candidate/pred_vs_gt__2025-08-10__n100.pdf}
\end{minipage}
...
\begin{figure}[!ht]
  ...
  % Erstes Bild: Ground Truth
  \begin{minipage}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y51.png}
    \caption*{Konfiguration 4, Original-Signal als Wert der Kritikalitätsfunktion \(k(\cdot)\) als \gls{GroundTruth}}
    \label{fig:bild41}
  \end{minipage}
  \hfill
  % Zweites Bild: Aleatorische Unsicherheit
  \begin{minipage}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y52.png}
    \caption*{Konfiguration 4, vom \gls{Evidenzbasierte neuronale Netze} erkannte \gls{Aleatorische Unsicherheit}}
    \label{fig:bild42}
  \end{minipage}
  \hfill
  % Drittes Bild: Epistemische Unsicherheit
  \begin{minipage}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y53.png}
...
\begin{figure}[!ht]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y61.png}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y63.png}
...
\begin{figure}[!ht]
  ...
  % Erstes Bild: Aleatorische Unsicherheit
  \begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y72.png}
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption*{Konfiguration 6, vom \gls{Evidenzbasierte neuronale Netze} erkannte \gls{Aleatorische Unsicherheit}}
    \label{fig:bild32}
  \end{minipage}%
  \hfill
  % Zweites Bild: Epistemische Unsicherheit
  \begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/y73.png}
    \captionsetup{justification=raggedright,singlelinecheck=false}
