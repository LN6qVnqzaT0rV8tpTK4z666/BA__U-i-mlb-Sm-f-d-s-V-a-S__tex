...
\begin{table}[htpb]
  ...
  \begin{tabular}{|l|p{\dimexpr\textwidth-3cm-2\tabcolsep}|}  
    ...
    \hline
    \begin{itemize}[topsep=0pt, itemsep=0pt, left=-1pt, labelsep=0,25em]
...
\begin{table}[htpb]
  \begin{tabular}{|l|p{10cm}|}
    ...
    \hline
  \end{tabular}
  \caption{R2 Allg. Fakt. Klassifizierung Unsicherheit KI-Systeme nach A. Kreuz ~\nocite{AndreasKreutz2022} ~\nocite{AndreasKreutz2022b}}\label{tab:chapter6r21}
\end{table}
...
\begin{table}[htpb]
  ...
  \begin{tabular}{|l|l|p{\dimexpr\textwidth-8cm-2\tabcolsep}|}  % Adjusted width
    ...
    \hline
  \end{tabular}
  \caption{R2 Modellspez. Fakt. Klassifizierung Unsicherheit Model A nach X Model B nach Y}\label{tab:chapter6r22}
\end{table}
