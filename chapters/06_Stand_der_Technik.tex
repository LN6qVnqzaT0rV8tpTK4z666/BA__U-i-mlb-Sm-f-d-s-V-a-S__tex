...
\begin{table}[!htpb]
  ...
  \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \hline
  \end{tabularx}
  \caption{R2 Abschwächung allgemeiner Faktoren KI Systeme}\label{tab:chapter6r21}
\end{table}
...
\begin{table}[!htpb]
  ...
  \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \hline
  \end{tabularx}
  \caption{R2.2 Abschwächung Modellspezifische Faktoren zur Unsicherheitsklassifizierung \gls{Bayesianische neuronale Netze}}\label{tab:chapter6r22}
\end{table}
...
\begin{table}[!htpb]
  ...
  \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \hline
  \end{tabularx}
  \caption{R2.2 Abschwächung Modellspezifische Faktoren zur Unsicherheitsklassifizierung \gls{Evidenzbasierte neuronale Netze}}\label{tab:chapter6r23}
\end{table}
