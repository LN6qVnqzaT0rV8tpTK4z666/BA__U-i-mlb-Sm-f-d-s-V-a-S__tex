...
% TODO: Sub-Literatur-Verzeichnisse umsetzen.
% Definiere Filter für die Teilbibliographien
%\DeclareBibliographyCategory{primaer}
%\DeclareBibliographyCategory{sekundaer}
...
% \defbibfilter{buchsammelwerkfilter}{keyword=buchsammelwerk}
% \defbibfilter{buchfilter}{keyword=buch}
% \defbibfilter{internetdokumentfilter}{keyword=internetdokument}

% \chapter{Literaturverzeichnis}

% \section*{Beitrag}
% \printbibliography[filter=beitrag, heading=none]

% \section*{Buch (Monographie)}
% \printbibliography[filter=buch, heading=none]

% \section*{Buch (Sammelwerk)}
% \printbibliography[filter=sammelwerk, heading=none]

% \section*{Zeitschriftenaufsatz}
% \printbibliography[filter=zeitschriftenaufsatz, heading=none]

% \section*{Internetdokument}
% \printbibliography[filter=internetdokument, heading=none]
